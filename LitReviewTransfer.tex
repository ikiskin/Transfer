...
% The motivation to excel in applications aligns with the need to innovate algorithms and architectures.
...
Despite immense popularity in image recognition, until recently there were relatively few convincing applications in signal processing. Similarly to how handcrafted scale-invariant features, Difference of Gaussians, and Histograms of Oriented Gradients [cit,cit,cit] were phased out with the advent of deep learning, handcrafted feature descriptors are beginning to undergo the same fate in acoustic signal processing. We illustrate this in Section \ref{sec:birdrecognition} with a bird recognition case study equivalent to ILSVRC. We further support this claim by reviewing advancements in the general field of acoustic event detection in Section \ref{sec:AED}.
...
\ganttgroup{Short-term}{1}{3} \\
\ganttbar{1. Wavelet theory}{1}{2} \\
\ganttlinkedbar{3. Feature learning}{3}{5} \\
\ganttbar{2. Data augmentation}{1}{3} \ganttnewline
\ganttgroup{Medium-term}{4}{10} \\
\ganttbar{2. NN automation}{6}{10} \\
\ganttbar{1. Deep Kernel Learning}{4}{8} \\
\ganttgroup{Long-term}{1}{24} \\
\ganttbar{1. DKL-wavelet}{11}{16} \\
\ganttbar{2. Dynamic detector}{1}{24} 
...
% \begin{ganttchart}[vgrid, hgrid]{1}{24} % 50 weeks
...
% \ganttbar{(8)}{13}{16} \\
% \ganttbar{(9)}{17}{20} \\
% \ganttmilestone{(10)}{20} \\
% \ganttbar{(11)}{21}{24} \\
% \ganttmilestone{(12)}{24}
% \end{ganttchart}
% }
% \caption{Gantt chart showing the planning timeline for Future thesis work on PIE over the next 24 months: (1) Investigating new NBV selection metrics, (2) Comparing quantitative performance with state-of-the-art approaches, (3) Testing on real world data, (4) Transfer of Status and submission to ICRA 2018, (5) Implementation of PIE for mobile platforms, (6) Deploy PIE on an autonomous platform, (7) Confirmation of Status and paper/journal submission, (8) Work on parameter reduction, (9) Implement feature recognition and change detection for real world applications, (10) Paper/journal submission, (11) Thesis writing and (12) Thesis submission.}
% \label{fig:gantt}
% \end{figure}
